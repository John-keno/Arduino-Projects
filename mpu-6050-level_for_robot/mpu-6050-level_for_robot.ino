...
// Serial.println(angle_roll_output);
  ...
  // Check Angle for Gyro and write to bluetooth
  
    if (angle_pitch_output > 20.01) {
    // turn robot right
//    Serial.println(F("turn robot right "));
    Serial.write('R'); 
    
    } else if (angle_roll_output > 20.00)  {
    // move foward
//    Serial.println(F("move foward "));
    Serial.write('F');
    } else if (((angle_pitch_output < 10.00) && (angle_pitch_output > -10.00))
    && ((angle_roll_output < 10.00) && (angle_roll_output > -10.00))) {
   //stop robot
//    Serial.println(F("stop robot "));
    Serial.write('S');
    } else if (angle_pitch_output < -20.01) {
    //turn robot left
//    Serial.println(F("robot left "));
    Serial.write('L');
    
    } else if (angle_roll_output < -20.01) {
    // move backwards
//    Serial.println(F("move backwards "));
    Serial.write('B');
    }
